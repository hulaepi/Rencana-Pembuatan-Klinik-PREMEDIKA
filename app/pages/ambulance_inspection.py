...
def ambulance_inspection_form() -> rx.Component:
    return rx.el.form(
        rx.el.h2(
            "Tambah Inspeksi Ambulans",
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.label(
                    "Nomor Polisi Ambulans",
                    class_name="block text-sm font-medium",
                ),
                rx.el.input(
                    name="nomor_polisi_ambulans",
        ...
        rx.el.div(
            rx.el.h3(
                "Item Checklist Ambulans",
                class_name="text-md font-semibold text-gray-700 mb-2",
            ),
            rx.el.form(
                rx.el.input(
                    name="current_ambulance_item_name_input",
                    placeholder="Nama Item (cth: Tabung Oksigen)",
                ...
                on_submit=DataState.handle_add_ambulance_item_submit,
                reset_on_submit=True,
                class_name="flex mb-3",
            ),
            rx.foreach(
                DataState.ambulance_inspection_items,
                lambda item, index: rx.el.div(
                    ...
                    rx.el.label(
                        rx.el.input(
                            ...
                            on_change=lambda checked: DataState.update_ambulance_item_in_form(
                                index,
                                "kondisi_checklist",
                                checked,
                            ),
                    ...
                    rx.el.input(
                        ...
                        on_change=lambda val: DataState.update_ambulance_item_in_form(
                            index, "catatan", val
                        ),
                    ...
                    rx.el.button(
                        ...
                        type="button",
                        on_click=lambda: DataState.remove_ambulance_item_from_form(
                            index
                        ),
        ...
        rx.el.div(
            rx.el.label(
                "Catatan Umum Inspeksi Ambulans",
                class_name="block text-sm font-medium",
            ),
            rx.el.textarea(
                name="catatan_umum",
    ...
    return rx.el.div(
        ...
        rx.el.div(
            rx.el.table(
                ...
                rx.el.tbody(
                    rx.foreach(
                        DataState.ambulance_inspections,
                    ...
                    rx.cond(
                        DataState.ambulance_inspections.length()
                        == 0,
                        rx.el.tr(
                            rx.el.td(
                                "Tidak ada data inspeksi ambulans.",
                                col_span=5,
...
def ambulance_inspection_page() -> rx.Component:
    return rx.el.div(
        sidebar(),
        rx.el.div(
            navbar(),
            rx.el.main(
                rx.el.h1(
                    "Manajemen Inspeksi Ambulans",
                    class_name="text-2xl font-bold text-gray-800 mb-6",
                ),
                ambulance_inspection_form(),
                ambulance_table(),
